...
parser.add_argument('--checkpoint_path', default='/home/t-pbansal/video-dalle/logs/2021-08-15T03:55:56.835995/checkpoint.pt.tar')
# parser.add_argument('--checkpoint_path', default='/home/t-pbansal/video-dalle/logs/2021-08-14T11:25:50.190672/checkpoint.pt.tar')
...
train_dataset = Balls(root=args.data_path, mode='train')
...
for epoch in range(start_epoch, args.epochs):
    ...
    with torch.no_grad():
        vis = visualize(video[:,-recon_transformer.shape[1]:], recon[:,-recon_transformer.shape[1]:], recon_transformer, N=args.num_vis)
        vis_grid = vutils.make_grid(vis, nrow=recon_transformer.shape[1], pad_value=1)
